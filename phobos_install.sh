...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='pbs.conf'
CONFIGFOLDER='/root/.pbs'
COIN_DAEMON='/usr/local/bin/pbsd'
COIN_CLI='/usr/local/bin/pbs-cli'
COIN_REPO='https://github.com/Phoboscurrency/PBSCoin/releases/download/v1.0.3/pbs-1.0.3-x86_64-linux-gnu.tar.gz'
COIN_NAME='Phobos'
COIN_PORT=51572
